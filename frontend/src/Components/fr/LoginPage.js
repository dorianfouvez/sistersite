...
let loginPage = `<div class="containerForm mb-3">
  <div class="mt-2 mb-2"><h1><center>Bon retour !</center></h1></div>
  <div class="d-flex justify-content-center h-100 mt-4">
    <div class="card">
      <div class="card-header">
      <h3><center>Se connecter</center></h3>
      </div>
      <div class="card-body text-center">
        <form id="login">
          ...
          <div class="form-group">
            <input type="submit" value="se connecter" class="btn btn-lg btn-outline-primary btn-block">   
          </div>
        </form>
      </div>
      <div class="card-footer">
        <div class="d-flex justify-content-center">
          <a data-toggle="tooltip" data-placement="top" title="Appel ton frère" id="tooltip"><small>Tu as oublié ton mot de passe ?</small></a>
        </div>
      </div>
    </div>
  </div>
